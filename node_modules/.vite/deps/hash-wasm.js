...
var getUInt8Buffer = nodeBuffer !== null ? (data2) => {
...
var getHashParameters = (password, encoded, secret) => {
...
var validateVerifyOptions$1 = (options) => {
  if (!options || typeof options !== "object") {
    throw new Error("Invalid options parameter. It requires an object.");
  }
...
var isPowerOfTwo = (v) => v && !(v & v - 1);
var validateOptions$1 = (options) => {
  if (!options || typeof options !== "object") {
    throw new Error("Invalid options parameter. It requires an object.");
  }
...
var validateHashCharacters = (hash2) => {
...
var validateVerifyOptions = (options) => {
  if (!options || typeof options !== "object") {
    throw new Error("Invalid options parameter. It requires an object.");
  }
  if (options.hash === void 0 || typeof options.hash !== "string") {
